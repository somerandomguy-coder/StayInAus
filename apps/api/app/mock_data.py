...
GEOGRAPHY_NODES = [
    ...
    },
    {
        ...
        "code": "SA_AC",
        "boundary_code": "401",
        "canonical_name": "SA4: Adelaide - Central and Hills",
    ...
    },
    {
        ...
        "code": "WA_GE",
        "boundary_code": "511",
        "canonical_name": "SA4: Western Australia - Outback (South)",
    ...
    },
    {
        ...
        "code": "ACT_CA",
        "boundary_code": "801",
        "canonical_name": "SA4: Australian Capital Territory",
    ...
    },
    {
        ...
        "code": "NT_OB",
        "boundary_code": "702",
        "canonical_name": "SA4: Northern Territory - Outback",
...
def build_map_layer(
    ...
    # Keep map and panel endpoint behavior aligned: unknown occupation returns 404.
    get_occupation(occupation_id)
